...
<head>
    ...
    <title>PENDAFTARAN LOMBA USIA DINI</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">PENDAFTARAN LOMBA USIA DINI -FKIP</a>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Peserta Lomba -FKIP</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold text-uppercase" id="detail">Detail Data Peserta</h5>
